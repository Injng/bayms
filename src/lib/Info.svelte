    ...
    <form method="POST" enctype="multipart/form-data" action="?/save">
        ...
        <div class="mb-4">
            ...
            >
                <option
                    value="Violin"
                    selected={user.instruments.includes("violin")}
                    >Violin</option
                >
                <option
                    value="Viola"
                    selected={user.instruments.includes("viola")}>Viola</option
                >
                <option
                    value="Cello"
                    selected={user.instruments.includes("cello")}>Cello</option
                >
                <option
                    value="Flute"
                    selected={user.instruments.includes("flute")}>Flute</option
                >
                <option
                    value="Oboe"
                    selected={user.instruments.includes("oboe")}>Oboe</option
                >
                <option
                    value="Clarinet"
                    selected={user.instruments.includes("clarinet")}
                    >Clarinet</option
                >
                <option
                    value="Bassoon"
                    selected={user.instruments.includes("bassoon")}
                    >Bassoon</option
                >
                <option
                    value="Saxophone"
                    selected={user.instruments.includes("saxophone")}
                    >Saxophone</option
                >
                <option
                    value="Trumpet"
                    selected={user.instruments.includes("trumpet")}
                    >Trumpet</option
                >
                <option
                    value="Piano"
                    selected={user.instruments.includes("piano")}>Piano</option
                >
                <option
                    value="Voice"
                    selected={user.instruments.includes("voice")}>Voice</option
                >
            </select>
            <p class="text-xs font-thin">Ctrl/Cmd for multiple selections</p>
            <p class="text-xs font-thin">
                Previously selected: {user.instruments.join(", ")}
            </p>
        </div>
        <div class="mb-4">
            <label
